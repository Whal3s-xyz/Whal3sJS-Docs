# -*- encoding: utf-8 -*-
# stub: padrino-helpers 0.15.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<padrino-support>.freeze, ["= 0.15.1"])
    s.add_runtime_dependency(%q<tilt>.freeze, [">= 1.4.1", "< 3"])
    s.add_runtime_dependency(%q<i18n>.freeze, [">= 0.6.7", "< 2"])
  else
    s.add_dependency(%q<padrino-support>.freeze, ["= 0.15.1"])
    s.add_dependency(%q<tilt>.freeze, [">= 1.4.1", "< 3"])
    s.add_dependency(%q<i18n>.freeze, [">= 0.6.7", "< 2"])
  end
end
